...
system.time(fit2a <- oem(x = x, y = y, penalty = c("grp.lasso"),
                         groups = rep(1:20, each = 5), nlambda = 100L))
system.time(fit2b <- oem(x = x, y = y, penalty = c("grp.lasso", "lasso", "mcp", "scad", "elastic.net"),
                         groups = rep(1:20, each = 5), nlambda = 100L))
system.time(fit2c <- oem(x = x, y = y, penalty = c("grp.lasso", "lasso", "mcp", "scad", "elastic.net"),
